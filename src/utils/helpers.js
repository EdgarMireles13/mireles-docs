...
export const enc = (exp) => {
  switch (exp.tipo) {
    case "amparo_indirecto":
      return `C. JUEZ DE DISTRITO EN MATERIA PENAL EN EL ESTADO DE NUEVO LEON (EN TURNO)
P  R  E  S  E  N  T  E`;
    case "amparo_directo":
      return `H. TRIBUNAL COLEGIADO EN MATERIAS CIVIL Y DE TRABAJO DEL CUARTO CIRCUITO (EN TURNO)
P  R  E  S  E  N  T  E`;
    case "laboral":
...
P  R  E  S  E  N  T  E`;
    case "civil":
      return `C. JUEZ CIVIL DEL PRIMER DISTRITO JUDICIAL EN EL ESTADO DE NUEVO LEON (EN TURNO)
P  R  E  S  E  N  T  E`;
    case "familiar":
      return `C. JUEZ DE LO FAMILIAR DEL PRIMER DISTRITO JUDICIAL EN EL ESTADO DE NUEVO LEON (EN TURNO)
P  R  E  S  E  N  T  E`;
    default:
